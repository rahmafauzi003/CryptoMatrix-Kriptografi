...
const SAMPLE_CASES = [
  { id: "cryptomatrix", name: "CryptoMatrix Vector", plaintext: 0xCAFE, key: 0xBEEF, ciphertext: 0x2855 },
];
...
function readSavedTheme() {
  try {
    return localStorage.getItem("cryptomatrix-theme");
  } catch {
    return null;
  }
}
...
function saveTheme(theme) {
  try {
    localStorage.setItem("cryptomatrix-theme", theme);
  } catch {
...
function initialize() {
  ...
  // Test vector tunggal CryptoMatrix: P=CAFE, K=BEEF → C=2855.
